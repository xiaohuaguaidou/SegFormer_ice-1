...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["background","sky", "ship", "white ice", "water",
                 "new ice", "grey ice", "old ice"]
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "VOCdevkit/VOC2007/JPEGImages_val"
    dir_save_path   = r"C:\Users\ysfys\Desktop\1"
    #-------------------------------------------------------------------------#
